...
$FormName = "Repair Client - $ColName"
...
$ReRunBtn_OnClick= 
{
	...
	$ArgList += @("`"$Directory\Collection - Repair Client.ps1`"")
	$ArgList += @("`"$ColID`"")
	$ArgList += @("`"$ColName`"")
...
$Answer = $Popup.Popup("Are you sure you want to repair the client on collection $ColName",0,"Successful",1)
