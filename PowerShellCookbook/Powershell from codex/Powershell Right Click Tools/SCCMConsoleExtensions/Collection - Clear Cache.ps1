...
$FormName = "Clear Cache - $ColName"
$strActionLbl = "Clear Cache"
...
$ReRunBtn_OnClick= 
{
	...
	$ArgList += @("`"$Directory\Collection - Clear Cache.ps1`"")
	$ArgList += @("`"$ColID`"")
	$ArgList += @("`"$ColName`"")
...
$Answer = $Popup.Popup("Are you sure you want to clear the cache on collection $ColName",0,"Successful",1)
