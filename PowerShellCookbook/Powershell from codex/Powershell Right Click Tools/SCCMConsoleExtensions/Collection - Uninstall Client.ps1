...
$FormName = "Uninstall Client - $ColName"
$strActionLbl = "Uninstall Client"
...
$ReRunBtn_OnClick= 
{
	...
	$ArgList += @("`"$Directory\Collection - Uninstall Client.ps1`"")
	$ArgList += @("`"$ColID`"")
	$ArgList += @("`"$ColName`"")
...
$Answer = $Popup.Popup("Are you sure you want to uninstall the client on collection $ColName",0,"Successful",1)
