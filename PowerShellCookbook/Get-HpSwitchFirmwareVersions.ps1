...
Requirements: 
  * The Posh-SSH module
  * A secure password file containing the switches' password as a secure string. One way
    to generate this file is to run the following commands:
        $Password = (Read-Host -Prompt "Enter the password to add to the file" -AsSecureString)
        ConvertFrom-SecureString -SecureString $Password | Out-File "C:\Passwords\myPassword.txt"
