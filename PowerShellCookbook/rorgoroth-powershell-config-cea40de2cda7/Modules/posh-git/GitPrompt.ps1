...
$global:GitPromptSettings = New-Object PSObject -Property @{
    ...
    LocalStagedStatusForegroundColor            = [ConsoleColor]::DarkCyan
    ...
    BranchIdenticalStatusToForegroundColor      = [ConsoleColor]::DarkCyan
    ...
    BranchBehindAndAheadStatusForegroundColor   = [ConsoleColor]::DarkGray
